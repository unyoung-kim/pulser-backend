...
Your task is to write a very long and detailed blog post, of length around 3500 words, based on the outline.
</Task>

<Rules>
<General>
1. Word count of the blog post MUST be around 3500 words. Follow this very strictly.
...
Think step by step before you write the SEO blog post and generate a 3000-3500 words blog post.
`;
