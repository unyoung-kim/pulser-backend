...
export const threeCircleHorizontalVisualizationTool = () =>
  tool({
    description: `
    This template represents a 'Three-Circle Horizontal Visualization' designed to showcase three distinct elements or concepts in a balanced and visually engaging layout. The layout includes:  
    1. A main header at the top for the overall title, with a sub-header below for additional context.  
    2. Three overlapping circular shapes arranged horizontally, each representing an element or concept.  
    3. Each circle contains:  
      - An icon at the top representing the element or concept visually.  
      - A bold title summarizing the element or concept.  
      - A description of upto three lines providing additional details below the title.  

    This template is ideal for presenting three key ideas, categories, or features in a simple and visually connected manner.
    `,
    parameters: z.object({
      header: z
        .string()
        .describe(
          "The main title summarizing the three-circle horizontal visualization."
        ),
      sub_header: z
        .string()
    ...
    execute: async (input) => {
      return {
        ...
        title_3_desc_line_3: "",
        ...input,
        template_name: "three-circle-horizontal-visualization",
